...
const Sidebar = () => {
  ...
  return (
    <>
        <div className="h-[calc(100vh-48px)] bg-primary min-w-10 py-8 z-10" onMouseEnter={() => setSidebarOpen(true)}>
        ...
        <div className={`h-[calc(100vh-48px)] w-[170px] absolute py-8 bg-secondary ${sidebarOpen ? "left-0" : "-left-[170px]"} duration-300 ease-in-out py-8`} onMouseLeave={() => setSidebarOpen(false)}>
