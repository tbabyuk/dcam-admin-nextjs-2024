...
const Navbar = () => {
  ...
  return (
    <div className="h-12 bg-primary px-2 sm:px-10 flex justify-between items-center">
        ...
        <div className="flex gap-4 sm:gap-6">
          ...
          {authenticatedUser && (<button className="btn btn-primary btn-sm flex items-center text-nowrap" onClick={() => logOut()}>Log Out</button>)}
        </div>
    </div>
  )
}
