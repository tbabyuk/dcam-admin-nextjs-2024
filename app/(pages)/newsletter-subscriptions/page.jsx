...
const NewsletterSubscriptionsPage = () => {
  ...
  return (
    <div className="dcam-container text-center overflow-y-auto">
        <p className="mb-12">Use this page to add students/families to our Mailchimp Newsletter or check their subscription status:</p>
        <button className="btn mb-3 md:mb-0 bg-green-400 rounded text-gray-50 hover:bg-green-500 text-sm" onClick={() => setNewSubscriberModalOpen(true)}>Add Subscriber</button>
